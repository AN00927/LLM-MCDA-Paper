#!/usr/bin/env python3
"""
generate_baseline_table.py - Incremental Contribution Table Generator

Reads metrics_summary_{MODEL_KEY}.xlsx (produced by evaluate_architecture_metrics.py with --include-baselines)
and prints/saves the incremental contribution table comparing all 5 systems:
- 2 baselines (FixedDefault, NearestNeighbor)
...
def generate_latex_table(pivot, inc_df):
    ...
    lines = []
    lines.append("% Incremental Contribution Table - Auto-generated by generate_baseline_table.py")
    lines.append("% DO NOT EDIT MANUALLY - Regenerate after running evaluate_architecture_metrics.py --include-baselines")
    lines.append("")
