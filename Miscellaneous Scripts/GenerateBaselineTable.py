...
and prints/saves the incremental contribution table comparing all 7 systems:
- 4 baselines (Random, Uniform, FixedDefault, NearestNeighbor)
...
def extract_key_metrics(metrics_df):
    ...
    expected_archs = ["Random", "Uniform", "FixedDefault", "NearestNeighbor", "Direct_LLM_Scoring", "Example-Guided_LLM_Scoring", "LLM-Parameterized_Reference_Scoring"]
