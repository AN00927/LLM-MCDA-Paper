...
Figure 1 (EIA, 2022) visualizes the emissions of the residential sector.
\begin{figure}[t]
	\centering
	% \includegraphics[width=0.8\textwidth]{Table 1-pennsylvania residential consumption.png}
	\caption{Residential Emissions of the past /~50 years}
...
\begin{figure}[t]
	\centering
	% \includegraphics[width=0.8\textwidth]{Table 2 - householdhabits.png}
...
This study directly addresses that question by comparing three architectures with varying levels of assistance against calculations made with further specified information. This study offers the first empirical comparison of LLM integration in three different contexts-Pure Prompting, RAG-Enhanced, and Hybrid parameter extraction-specifically for household energy decision-making by testing across 100 scenarios, determining which method best replicates an actual expert's MCDA scoring.
