...
\citep{firstenergy2025,firstenergy2026}. Duquesne uses a flat default rate
...
on the flat rate.\subsection{Electricity Rate Provenance}
...
\caption{Each row perturbs one criterion's weight by $\pm0.05$ from baseline (bold); the other three weights are rescaled proportionally to keep the vector summing to 1. The architecture ordering is preserved across all perturbations (Section~4.7 of the main paper).}
