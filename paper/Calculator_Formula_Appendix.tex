...
\mathrm{EER}_{\mathrm{eff}} = -0.02\,\mathrm{SEER}_{\mathrm{eff}}^{2} + 1.12\,\mathrm{SEER}_{\mathrm{eff}}
\end{equation}
\noindent\textit{Source note:} where $\mathrm{EER}_{\mathrm{eff}}$ stands for effective EER and $\mathrm{SEER}_{\mathrm{eff}}$ stands for effective SEER after degradation. This quadratic relationship is derived from the AHRI 210/240 standard rating conditions; Sources: Air-Conditioning, Heating, and Refrigeration Institute (AHRI), \emph{Performance Rating of Unitary Air-Conditioning and Air-Source Heat Pump Equipment}, AHRI Standard 210/240; Krarti, M.; Howarth, N., \emph{Transitioning to high efficiency air conditioning in Saudi Arabia: A benefit cost analysis for residential buildings}.
