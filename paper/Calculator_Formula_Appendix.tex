...
\dot V_{\mathrm{hot}} = 0.65\,\dot V
\end{equation}
\noindent\textit{Source note:} where $\dot V_{\mathrm{hot}}$ stands for hot-water flow rate and $\dot V$ stands for total shower flow rate. Sources: Maguire, J. et al., \emph{Validation of a hot water distribution model using laboratory and field data}; Zhang, D.; Mui, K.-W.; Wong, L.-T., \emph{Establishing the relationship between occupants' thermal behavior and energy consumption during showering}.
